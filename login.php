...
<head>
    ...
    <style>
        body { background: #eef2f7; display: flex; align-items: center; justify-content: center; height: 100vh; margin: 0; font-family: 'Segoe UI', sans-serif; }
        ...
        .form-group label { display: block; font-size: 11px; font-weight: bold; margin-bottom: 5px; color: #3c4043; letter-spacing: 1px; }
        ...
        .btn-login { width: 100%; padding: 12px; background: #1a73e8; color: white; border: none; border-radius: 4px; font-weight: bold; cursor: pointer; font-size: 16px; transition: background 0.3s; }
        .btn-login:hover { background: #1765cc; }
        .alert { padding: 12px; background: #fdecea; color: #d32f2f; border: 1px solid #f5c6cb; border-radius: 4px; margin-bottom: 20px; font-size: 13px; text-align: left; }
        .success { padding: 12px; background: #e6fffa; color: #2c7a7b; border: 1px solid #b2f5ea; border-radius: 4px; margin-bottom: 20px; font-size: 13px; }
    </style>
</head>
<body>
